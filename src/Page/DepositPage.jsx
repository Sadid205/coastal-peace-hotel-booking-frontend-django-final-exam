            ...
            <div className="flex items-center justify-center w-screen h-screen dark:bg-gray-900">
                ...
                <div id="back-div" className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-[26px] m-4">
                    ...
                    <form onSubmit={depositHandle} className="space-y-4">
                        ...
                        <button className="w-full p-2 mt-6 text-white transition duration-300 ease-in-out rounded-lg shadow-lg bg-gradient-to-r dark:text-gray-300 from-blue-500 to-purple-500 hover:scale-105 hover:from-purple-500 hover:to-blue-500" type="submit">
                        Deposit
                        </button>
                    </form>
                    </div>
