...
const EditReviewPage=()=>{
    ...
    useEffect(()=>{
        ...
        const user_review = await fetch(`${VITE_REQUEST_URL}reviews/list/${review_id}/`,{method:"GET",headers:{'Authorization':`Token ${token}`,'Content-Type':'application/json'}})
    ...
    const updateReview = async(e)=>{
       ...
       try{
          setIsLoading(true)
          const updateRequest =  await fetch(`${VITE_REQUEST_URL}reviews/list/${review_id}/`,{method:"PUT",headers:{'Authorization':`Token ${token}`,'Content-Type':'application/json'},
          body:JSON.stringify({
            hotel:hotel_id,
            reviewer:guestId,
